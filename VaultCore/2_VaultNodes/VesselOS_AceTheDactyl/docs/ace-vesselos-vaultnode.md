...
- **vn-garden-chronicles-001** - Frontend Scrolls (Phase 2)
- **vn-kira-prime-001** - System Brain (Phase 3)
- **vn-living-library-001** - Git Integration (Phase 4)
- **vn-narrative-channel-001** - Story Assembly (Phase 5)
- **vn-dev-sandbox-001** - Research Lab (Phase 6)
